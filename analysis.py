...
try:
    ts = pd.read_csv("time_data.csv/part-00000-637543a5-b6c3-41c3-8d14-881d3e78da07-c000.csv") 
except:
    exit(-1)
...
state_data = pd.read_csv("state_data.csv/part-00000-f6721959-48f4-4c0b-964b-7f2ff9a04095-c000.csv")
...
story = pd.read_csv("submission_score.csv/part-00000-4c727b3f-de27-4a56-8cbb-2e976a8848e1-c000.csv")
plt.figure(figsize=(12,5))
fig = plt.figure()
...
story = pd.read_csv("comment_score.csv/part-00000-f068459d-791d-4591-ac01-703ea59b29ce-c000.csv")
plt.figure(figsize=(12,5))
fig = plt.figure()
ax1 = fig.add_subplot(111)
