...
time.data <- read.csv("time_data.csv/part-00000-637543a5-b6c3-41c3-8d14-881d3e78da07-c000.csv", stringsAsFactors=FALSE)
...
comment.data <- read.csv("comment_score.csv/part-00000-f068459d-791d-4591-ac01-703ea59b29ce-c000.csv", quote="", header=TRUE)
